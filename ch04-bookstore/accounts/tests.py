...
class CustomUserTests(TestCase):  # noqa: D101
    def test_create_user(self):  # noqa: ANN101, ANN201, D102
        user = User.objects.create_user(
            ...
            password="testpass123",  # noqa: COM812, S106
        )
        assert user.username == "will"  # noqa: S101
        assert user.email == "will@email.com"  # noqa: S101
    ...
    def test_create_superuser(self):  # noqa: ANN101, ANN201, D102
        ...
        assert admin_user.username == "superadmin"  # noqa: S101
        assert admin_user.email == "superadmin@email.com"  # noqa: S101
